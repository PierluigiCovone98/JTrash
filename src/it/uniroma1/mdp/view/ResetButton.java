...
import it.uniroma1.mdp.controller.ResetButtonHandler;


/**
* Represents a reset button with specific styling for the application.
...
public class ResetButton extends ImageButton {
	 ...
	 */
	public ResetButton() {
		super("images/frame/resetB.png", "images/frame/resetR.png", WIDTH, HEIGHT);
	...
	/**
     * Set ups the "Reset" button, including shared button details, pressed icon, listeners, and tooltip text.
     */
	@Override
	protected void setup() {
		...
		setToolTipText("Reset Statistics");
	}
}
